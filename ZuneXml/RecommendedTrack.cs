...
namespace ZuneXml
{
    ...
    {
        internal static XmlDataProviderObject ConstructRecommendedTrackObject(
          DataProviderQuery owner,
          object objectTypeCookie)
        {
            return (XmlDataProviderObject)new RecommendedTrack(owner, objectTypeCookie);
        }
