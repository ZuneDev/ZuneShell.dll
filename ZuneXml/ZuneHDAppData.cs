...
namespace ZuneXml
{
    ...
    {
        internal static XmlDataProviderObject ConstructZuneHDAppDataObject(
          DataProviderQuery owner,
          object objectTypeCookie)
        {
            return (XmlDataProviderObject)new ZuneHDAppData(owner, objectTypeCookie);
        }
