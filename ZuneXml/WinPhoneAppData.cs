...
namespace ZuneXml
{
    ...
    {
        internal static XmlDataProviderObject ConstructWinPhoneAppDataObject(
          DataProviderQuery owner,
          object objectTypeCookie)
        {
            return (XmlDataProviderObject)new WinPhoneAppData(owner, objectTypeCookie);
        }
