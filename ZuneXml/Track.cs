...
namespace ZuneXml
{
    internal class Track : Media
    {
        ...
        internal virtual int UserRating
        {
            get
            {
                this._userRating = RecommendationsHelper.GetUserRating((DataProviderObject)this);
        ...
        {
            return (XmlDataProviderObject)new Track(owner, objectTypeCookie);
        }
