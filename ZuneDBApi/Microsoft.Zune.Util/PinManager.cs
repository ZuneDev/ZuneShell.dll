...
public class PinManager : IDisposable
{
			...
			if (sm_PinManager == null)
			{
				try
				{
					...
					if (sm_PinManager == null)
					{
						...
						System.Runtime.CompilerServices.Unsafe.SkipInit(out IPinProvider* pPinProvider);
						int num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, _GUID, void**, int>)(*(ulong*)(*(long*)ptr + 24)))((nint)ptr, (_GUID)global::_003CModule_003E._GUID_b396c324_6ab3_4e8e_a5cd_aafb3e01bedc, (void**)(&pPinProvider));
						if (num < 0)
						{
	...
	public unsafe HRESULT AddPin(EPinType ePinType, string szPinServiceRef, string szDescription, EServiceMediaType ePinServiceTypeId, int nUserId, int nOrdinal, out int nPinId)
	{
		...
		//IL_001b->IL001d: Incompatible stack types: I8 vs Ref
		fixed (ushort* ptr = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(szPinServiceRef)))
		{
			fixed (ushort* ptr2 = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(szDescription)))
			{
				int num = -1;
				int* ptr3 = (int*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref EPinType.ePinTypeQuickMix == ePinType ? ref *(_003F*)(&nOrdinal) : ref *(_003F*)null);
				long num2 = *(long*)m_pPinProvider + 24;
				int hr = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EPinType, ushort*, ushort*, EServiceMediaType, int, int*, int*, int>)(*(ulong*)num2))((nint)m_pPinProvider, ePinType, ptr, ptr2, ePinServiceTypeId, nUserId, ptr3, &num);
				nPinId = num;
	...
	public unsafe HRESULT AddPin(EPinType ePinType, int nPinMediaId, EMediaTypes ePinTypeId, int nUserId, int nOrdinal, out int pinId)
	{
		...
		//IL_000b->IL000d: Incompatible stack types: I8 vs Ref
		int num = -1;
		int* ptr = (int*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref EPinType.ePinTypeQuickMix == ePinType ? ref *(_003F*)(&nOrdinal) : ref *(_003F*)null);
		IPinProvider* pPinProvider = m_pPinProvider;
	...
	public unsafe HRESULT FindPin(EPinType ePinType, string szPinServiceRef, EServiceMediaType ePinServiceTypeId, int nUserId, int nMaxAge, out int nPinId)
	{
		...
		fixed (ushort* ptr = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(szPinServiceRef)))
		{
			...
			int hr = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EPinType, ushort*, EServiceMediaType, int, int, int*, int>)(*(ulong*)num2))((nint)m_pPinProvider, ePinType, ptr, ePinServiceTypeId, nUserId, nMaxAge, &num);
			nPinId = num;
			return new HRESULT(hr);
		}
	}
