...
public class UpdateManager : IDisposable
{
	...
	public unsafe void BeginUpdateCheck(UpdateProgressHandler updateProgressHandler)
	{
		...
		UpdateProxy* ptr2 = (UpdateProxy*)global::_003CModule_003E.@new(24uL);
		UpdateProxy* ptr3;
		try
		{
	...
	public unsafe void InstallUpdate(UpdateProgressHandler updateProgressHandler)
	{
		...
		UpdateProxy* ptr = (UpdateProxy*)global::_003CModule_003E.@new(24uL);
		UpdateProxy* ptr2;
		try
		{
		...
		try
		{
			...
			if (0L == (nint)p)
			{
				System.Runtime.CompilerServices.Unsafe.SkipInit(out CComPtrNtv_003CIUpdateManager_003E cComPtrNtv_003CIUpdateManager_003E);
