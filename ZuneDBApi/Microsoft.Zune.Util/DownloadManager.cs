...
public class DownloadManager : IDisposable
{
	...
	public unsafe bool Finished
	{
		...
		get
		{
			return *(int*)((ulong)(nint)m_pDownloadManagerProxy + 8uL) <= 0;
		}
	}
	...
	public unsafe DownloadTask GetTask(string taskId)
	{
		...
		fixed (ushort* ptr3 = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(taskId)))
		{
			...
			if (singleton >= 0)
			{
				...
				singleton = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, ushort*, IDownloadTask**, int>)(*(ulong*)num))((nint)ptr, ptr3, &ptr2);
				if (singleton >= 0)
				{
	...
	public unsafe bool SignInRequired()
	{
		...
		if (global::_003CModule_003E.GetSingleton((_GUID)global::_003CModule_003E._GUID_399f851b_a600_4e88_90c3_03b8f2770076, (void**)(&ptr)) >= 0)
		{
			...
			if (0 < num)
			{
				...
				{
					IDownloadTask* ptr2 = null;
					if (((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int, IDownloadTask**, int>)(*(ulong*)(*(long*)ptr + 104)))((nint)ptr, num2, &ptr2) >= 0)
					{
						IDownloadTask* intPtr2 = ptr2;
						if (((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EDownloadType>)(*(ulong*)(*(long*)intPtr2 + 144)))((nint)intPtr2) == (EDownloadType)0)
						{
							flag = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int*, EDownloadTaskState>)(*(ulong*)(*(long*)ptr2 + 200)))((nint)ptr2, null) == EDownloadTaskState.DLTaskPendingAttach || flag;
						}
					}
					if (0L != (nint)ptr2)
					{
	...
	private unsafe DownloadManager()
	{
		...
		DownloadManagerProxy* ptr = (DownloadManagerProxy*)global::_003CModule_003E.@new(112uL);
	...
	private unsafe static void UpdateActiveListOnWorkerThread(object args)
	{
		...
		System.Runtime.CompilerServices.Unsafe.SkipInit(out CComPtrNtv_003CIDownloadManager_003E cComPtrNtv_003CIDownloadManager_003E);
		*(long*)(&cComPtrNtv_003CIDownloadManager_003E) = 0L;
		try
		{
			...
			if (singleton >= 0)
			{
				num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int>)(*(ulong*)(*(long*)(*(ulong*)(&cComPtrNtv_003CIDownloadManager_003E)) + 88)))((nint)(*(long*)(&cComPtrNtv_003CIDownloadManager_003E)));
				num = ((num >= 0) ? num : 0);
			}
			...
			if (0 < num)
			{
				System.Runtime.CompilerServices.Unsafe.SkipInit(out CComPtrNtv_003CIDownloadTask_003E cComPtrNtv_003CIDownloadTask_003E);
				do
				{
					*(long*)(&cComPtrNtv_003CIDownloadTask_003E) = 0L;
					try
					{
						singleton = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int, IDownloadTask**, int>)(*(ulong*)(*(long*)(*(ulong*)(&cComPtrNtv_003CIDownloadManager_003E)) + 104)))((nint)(*(long*)(&cComPtrNtv_003CIDownloadManager_003E)), num2, (IDownloadTask**)(&cComPtrNtv_003CIDownloadTask_003E));
						if (singleton >= 0 && ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EDownloadType>)(*(ulong*)(*(long*)(*(ulong*)(&cComPtrNtv_003CIDownloadTask_003E)) + 144)))((nint)(*(long*)(&cComPtrNtv_003CIDownloadTask_003E))) == (EDownloadType)0 && ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int*, EDownloadTaskState>)(*(ulong*)(*(long*)(*(ulong*)(&cComPtrNtv_003CIDownloadTask_003E)) + 200)))((nint)(*(long*)(&cComPtrNtv_003CIDownloadTask_003E)), null) != EDownloadTaskState.DLTaskComplete)
						{
			...
			Application.DeferredInvoke(((DownloadManager)args).DeferredUpdateActiveList, list);
		}
		catch
		{
			//try-fault
	...
	private void DeferredUpdatePositions(object args)
	{
		...
		if (position <= m_activeDownloadTasks.Count && position >= 0)
		{
			...
			do
			{
				if (downloadManagerMoveArguments.Tasks[num] is DownloadTask item)
				{
					int num2 = m_activeDownloadTasks.IndexOf(item);
					if (num2 >= 0)
					{
