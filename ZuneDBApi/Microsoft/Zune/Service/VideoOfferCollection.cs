		...
		internal unsafe int Init(IVideoCollection* pCollection)
		{
			...
			if (0 < num2)
			{
				do
				{
					...
					_003CModule_003E.VideoMetadata_002E_007Bctor_007D(&videoMetadata);
					try
					{
						if (num >= 0)
						{
							...
							if (num >= 0)
							{
								Guid id = _003CModule_003E.GUIDToGuid(System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, _GUID>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 8)));
								Guid albumId = _003CModule_003E.GUIDToGuid(System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, _GUID>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 80)));
								...
								long num8 = System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, long>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192));
								bool flag = ((((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int>)(*(ulong*)(*(long*)System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, ulong>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192)) + 144)))((nint)num8) != 0) ? true : false);
								int releaseYear = 0;
								...
								{
									releaseYear = _003CModule_003E._wtoi((ushort*)System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, ulong>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 144)));
								}
								...
								*(int*)(&_0024ArrayType_0024_0024_0024BY0N_0040UVideoOfferParams_0040Service_0040Zune_0040Microsoft_0040_0040) = 3;
								...
								long num10 = (nint)System.Runtime.CompilerServices.Unsafe.AsPointer(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref _0024ArrayType_0024_0024_0024BY0N_0040UVideoOfferParams_0040Service_0040Zune_0040Microsoft_0040_0040, 4));
								long num11 = (nint)System.Runtime.CompilerServices.Unsafe.AsPointer(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref _0024ArrayType_0024_0024_0024BY0N_0040UVideoOfferParams_0040Service_0040Zune_0040Microsoft_0040_0040, 8));
								while (num6 == 0)
								{
									int num12 = *(int*)ptr;
									...
									try
									{
										if (!flag2 && !flag3)
										{
											...
											long num13 = System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, long>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192));
											bool flag5 = ((((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EMediaRights, EMediaFormat, int, int, int>)(*(ulong*)(*(long*)System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, ulong>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192)) + 168)))((nint)num13, eMediaRights, (EMediaFormat)num14, 1, 1) != 0) ? true : false);
											flag6 = flag5;
										}
										string expirationDate = new string((char*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref (long)(nint)ptr2 != 0 ? ref *(_0024ArrayType_0024_0024_0024BY00_0024_0024CBG*)ptr2 : ref _003CModule_003E._003F_003F_C_0040_11LOCGONAA_0040_003F_0024AA_003F_0024AA_0040));
										VideoOffer value = new VideoOffer(id, title, seriesTitle, System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, int>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 128)), System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, int>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 132)), artist, albumId, genre, releaseYear, previewImageUrl, productionCompany, new PriceInfo(_003CModule_003E.CComPtrNtv_003CIPriceInfo_003E_002E_002EPEAUIPriceInfo_0040_0040(&cComPtrNtv_003CIPriceInfo_003E)), flag7, isRental, flag4, isMusicVideo, flag3, flag6, flag, expirationDate);
										list.Add(value);
										num4 = 1;
										...
										long num15 = System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, long>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192));
										if (((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EMediaRights, EMediaFormat, EMediaFormat, int>)(*(ulong*)(*(long*)System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, ulong>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192)) + 64)))((nint)num15, (EMediaRights)num12, (EMediaFormat)3, (EMediaFormat)4) == 0)
										{
											goto IL_051c;
										}
										num6 = (flag ? 1 : 0);
										...
										{
											long num16 = System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, long>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192));
											num7 = ((((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EMediaRights, EMediaFormat, int>)(*(ulong*)(*(long*)System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, ulong>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192)) + 72)))((nint)num16, (EMediaRights)num12, (EMediaFormat)2) != 0) ? 1 : num7);
										}
										if (num5 == 0 && flag7 && flag9 && flag6)
										{
											long num17 = System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, long>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192));
											if (((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EMediaRights, EMediaFormat, EMediaFormat, int>)(*(ulong*)(*(long*)System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, ulong>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192)) + 64)))((nint)num17, (EMediaRights)num12, (EMediaFormat)2, (EMediaFormat)3) != 0)
											{
									...
									long num18 = System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, long>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192));
									flag3 = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, ESeasonPurchaseFlags, int>)(*(ulong*)(*(long*)System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, ulong>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192)) + 224)))((nint)num18, eSeasonPurchaseFlags) == 1;
									...
									try
									{
										...
										_GUID gUID_NULL3 = _003CModule_003E.GUID_NULL;
										int num19 = *(int*)num11;
										int num21;
										if (num19 != -1)
										{
											long num20 = System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, long>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192));
											IPriceInfo** intPtr = _003CModule_003E.CComPtrNtv_003CIPriceInfo_003E_002E_0026(&cComPtrNtv_003CIPriceInfo_003E);
											num21 = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EMediaRights, EMediaFormat, EMediaFormat, _GUID*, _GUID*, _GUID*, IPriceInfo**, ushort**, int>)(*(ulong*)(*(long*)System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, ulong>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192)) + 128)))((nint)num20, (EMediaRights)num12, (EMediaFormat)num14, (EMediaFormat)num19, &gUID_NULL2, &gUID_NULL3, &gUID_NULL, intPtr, &ptr2);
										}
										else
										{
											long num22 = System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, long>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192));
											IPriceInfo** intPtr2 = _003CModule_003E.CComPtrNtv_003CIPriceInfo_003E_002E_0026(&cComPtrNtv_003CIPriceInfo_003E);
											num21 = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EMediaRights, EMediaFormat, _GUID*, _GUID*, IPriceInfo**, ushort**, int>)(*(ulong*)(*(long*)System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, ulong>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192)) + 136)))((nint)num22, (EMediaRights)num12, (EMediaFormat)num14, &gUID_NULL2, &gUID_NULL, intPtr2, &ptr2);
										}
										if (num21 >= 0)
										{
											...
											long num24 = System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, long>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192));
											flag2 = ((((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EMediaRights, EMediaFormat, int, int, int>)(*(ulong*)(*(long*)System.Runtime.CompilerServices.Unsafe.As<VideoMetadata, ulong>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref videoMetadata, 192)) + 168)))((nint)num24, (EMediaRights)num12, (EMediaFormat)num14, 1, 1) != 0) ? true : false);
											flag6 = flag2;
					...
					{
						//try-fault
						_003CModule_003E.___CxxCallUnwindDtor((delegate*<void*, void>)(delegate*<VideoMetadata*, void>)(&_003CModule_003E.VideoMetadata_002E_007Bdtor_007D), &videoMetadata);
						throw;
					}
					_003CModule_003E.VideoMetadata_002E_007Bdtor_007D(&videoMetadata);
					num3++;
				}
				while (num3 < num2);
				if (num < 0)
