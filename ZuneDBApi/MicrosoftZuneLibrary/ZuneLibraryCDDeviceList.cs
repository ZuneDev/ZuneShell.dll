...
public class ZuneLibraryCDDeviceList : IDisposable
{
	...
	public unsafe ZuneLibraryCDDeviceList(IWMPCDDeviceList* pDeviceList)
	{
		...
		CDDeviceCallback* ptr = (CDDeviceCallback*)global::_003CModule_003E.@new(24uL);
		...
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IZuneCDDeviceCallback* ptr3);
		if (ptr2 == null || ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, _GUID*, void**, int>)(*(ulong*)(*(ulong*)ptr2)))((nint)ptr2, (_GUID*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E.IID_IUnknown), (void**)(&ptr3)) < 0)
		{
			return;
		}
		fixed (uint* ptr4 = &m_dwAdviseCookie)
		{
			try
			{
				...
				if (((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, IZuneCDDeviceCallback*, uint*, int>)(*(ulong*)num))((nint)m_pDeviceList, ptr3, ptr4) >= 0)
				{
					m_fAdvised = true;
				}
	...
	private unsafe void _0021ZuneLibraryCDDeviceList()
	{
		...
		if (pDeviceList != null)
		{
			if (m_fAdvised)
			{
				((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, uint, int>)(*(ulong*)(*(long*)pDeviceList + 56)))((nint)pDeviceList, m_dwAdviseCookie);
				m_fAdvised = false;
			}
