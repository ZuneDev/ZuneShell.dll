...
public class ZuneQueryList : IDisposable
{
	...
	public unsafe ZuneQueryList(IDatabaseQueryResults* pResults, string queryName)
	{
		...
		m_pResults = pResults;
		fixed (ushort* ptr = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(queryName)))
		{
			...
			if (pResults2 != null)
			{
				...
				ResultSetEventRelay* ptr2 = (ResultSetEventRelay*)global::_003CModule_003E.@new(56uL);
	...
	private unsafe void _007EZuneQueryList()
	{
		...
		if (0L != (nint)pRelay)
		{
			global::_003CModule_003E.MicrosoftZuneLibrary_002EResultSetEventRelay_002E__delDtor(pRelay, 1u);
			m_pRelay = null;
		}
	...
	public unsafe bool CheckItemIndex(uint index)
	{
		...
		IDatabaseQueryResults* pResults = m_pResults;
		return ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, uint, int>)(*(ulong*)(*(long*)pResults + 24)))((nint)pResults, index) >= 0;
	}
	...
	public unsafe object GetFieldValue(uint index, Type type, uint Atom, object defaultValue)
	{
		...
		if (m_disposed)
		{
			if (Atom != 340 && Atom != 140 && global::_003CModule_003E.WPP_GLOBAL_Control != System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E.WPP_GLOBAL_Control) && (*(int*)((ulong)(nint)global::_003CModule_003E.WPP_GLOBAL_Control + 28uL) & 2) != 0 && (uint)(*(byte*)((ulong)(nint)global::_003CModule_003E.WPP_GLOBAL_Control + 25uL)) >= 5u)
			{
				global::_003CModule_003E.WPP_SF_D(*(ulong*)((ulong)(nint)global::_003CModule_003E.WPP_GLOBAL_Control + 16uL), 10, (_GUID*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003FA0xfab9896e_002EWPP_ZuneDBList_cpp_Traceguids), Atom);
			}
			return defaultValue;
		}
		...
		if (m_pResults != null)
		{
			...
			{
				WMT_ATTR_DATATYPE wMT_ATTR_DATATYPE = *(WMT_ATTR_DATATYPE*)((ref *(_003F*)((long)(int)Atom * 32L)) + (ref System.Runtime.CompilerServices.Unsafe.As<_0024ArrayType_0024_0024_0024BY0A_0040_0024_0024CBU_SCHEMAMAPENTRY_0040CSchemaMap_0040_0040, _003F>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref global::_003CModule_003E._003Fs_rgSchemaMapEntry_0040CSchemaMap_0040_00400QBU_SCHEMAMAPENTRY_00401_0040B, 16))));
	...
	public unsafe uint GetIndexForLibraryId(int indexHint, int LibraryId)
	{
		...
		fixed (uint* ptr = &System.Runtime.CompilerServices.Unsafe.AsRef<uint>(&num))
		{
			...
			if (pResults != null)
			{
				...
				num = ((((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, uint, int, uint*, int>)(*(ulong*)num2))((nint)m_pResults, (uint)indexHint, LibraryId, ptr) != 0) ? uint.MaxValue : num);
			}
			return num;
		}
	}
	...
	public unsafe ArrayList GetUniqueIds()
	{
		...
		int num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int*, int*, int>)(*(ulong*)(*(long*)pResults + 152)))((nint)pResults, null, &num2);
		if (num >= 0)
		{
			ulong num3 = (ulong)num2;
			int* ptr = (int*)global::_003CModule_003E.new_005B_005D((num3 > 4611686018427387903L) ? ulong.MaxValue : (num3 * 4));
			num = (((long)(nint)ptr == 0) ? (-2147024882) : num);
			if (num >= 0)
			{
				pResults = m_pResults;
				num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int*, int*, int>)(*(ulong*)(*(long*)pResults + 152)))((nint)pResults, ptr, &num2);
				if (num >= 0)
				{
					arrayList = new ArrayList(num2);
					num = ((arrayList == null) ? (-2147024882) : num);
					if (num >= 0)
					{
						int num4 = 0;
						if (0 < num2)
	...
	public unsafe int SearchForString(uint Atom, [MarshalAs(UnmanagedType.U1)] bool ascending, string SearchString)
	{
		...
		if (m_pResults != null)
		{
			fixed (ushort* ptr = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(SearchString)))
			{
				try
				{
					long num2 = *(long*)m_pResults + 72;
					System.Runtime.CompilerServices.Unsafe.SkipInit(out uint num3);
					num = ((((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, uint, int, ushort*, uint*, int>)(*(ulong*)num2))((nint)m_pResults, Atom, ascending ? 1 : 0, ptr, &num3) >= 0) ? ((int)num3) : num);
				}
				catch
				{
					//try-fault
		...
		else if (typeof(IList).IsAssignableFrom(type))
		{
			...
			case 8200:
			{
				...
				if (arrayList2 != null)
				{
					int num5 = 0;
					int num6 = 0;
					System.Runtime.CompilerServices.Unsafe.SkipInit(out ushort** ptr3);
					if (global::_003CModule_003E.SafeArrayGetLBound(ptr2, 1u, &num5) < 0 || global::_003CModule_003E.SafeArrayGetUBound(ptr2, 1u, &num6) < 0 || global::_003CModule_003E.SafeArrayAccessData(ptr2, (void**)(&ptr3)) < 0)
					{
						return defaultValue;
					}
	...
	public unsafe static int ConvertTypeToPropVariant(Type type, object value, tagPROPVARIANT* propVariant)
	{
		...
		if (type == typeof(string))
		{
			*(short*)propVariant = 8;
			...
			{
				*(long*)((ulong)(nint)propVariant + 8uL) = (nint)global::_003CModule_003E.SysAllocString(ptr);
				return 0;
			}
		}
		if (type == typeof(int))
		...
		else if (typeof(IList).IsAssignableFrom(type))
		{
			...
			if (list != null)
			{
				...
				{
					System.Runtime.CompilerServices.Unsafe.SkipInit(out _0024ArrayType_0024_0024_0024BY00UtagSAFEARRAYBOUND_0040_0040 _0024ArrayType_0024_0024_0024BY00UtagSAFEARRAYBOUND_0040_0040);
					...
					*(int*)(&_0024ArrayType_0024_0024_0024BY00UtagSAFEARRAYBOUND_0040_0040) = count;
					tagSAFEARRAY* ptr2 = global::_003CModule_003E.SafeArrayCreate(8, 1u, (tagSAFEARRAYBOUND*)(&_0024ArrayType_0024_0024_0024BY00UtagSAFEARRAYBOUND_0040_0040));
					if (ptr2 == null)
					{
						return -2147024882;
					}
					System.Runtime.CompilerServices.Unsafe.SkipInit(out _0024ArrayType_0024_0024_0024BY01J _0024ArrayType_0024_0024_0024BY01J);
					...
					if (0 < count)
					{
						...
						if (obj != null)
						{
							if (obj.GetType() == typeof(string))
							{
								while (true)
								{
									fixed (ushort* ptr3 = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars((string)obj)))
									{
										ushort* ptr4 = global::_003CModule_003E.SysAllocString(ptr3);
										if (ptr4 != null)
										{
											*(int*)(&_0024ArrayType_0024_0024_0024BY01J) = num3;
											result = global::_003CModule_003E.SafeArrayPutElement(ptr2, (int*)(&_0024ArrayType_0024_0024_0024BY01J), ptr4);
											if (result < 0)
											{
												goto IL_0299;
											}
	...
	{
		fixed (ushort* wszName = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(AtomName)))
		{
	...
	public unsafe static string AtomToAtomName(int atom)
	{
		...
		return new string((char*)(*(ulong*)((ref *(_003F*)((long)atom * 32L)) + (ref System.Runtime.CompilerServices.Unsafe.As<_0024ArrayType_0024_0024_0024BY0A_0040_0024_0024CBU_SCHEMAMAPENTRY_0040CSchemaMap_0040_0040, _003F>(ref global::_003CModule_003E._003Fs_rgSchemaMapEntry_0040CSchemaMap_0040_00400QBU_SCHEMAMAPENTRY_00401_0040B)))));
	}
