...
public unsafe class ZuneLibraryCDDevice(IWMPCDDevice* pDevice) : IDisposable
{
	...
	private unsafe IBurnPublisher* BurnPublisher
	{
		get
		{
			...
			if (m_pBurnPublisher == null && pDevice != null)
			{
	...
	public unsafe static bool IsImapiv2Installed
	{
		...
		get
		{
			...
			{
				System.Runtime.CompilerServices.Unsafe.SkipInit(out IUnknown* ptr);
				flag = global::_003CModule_003E.CoCreateInstance((_GUID*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E.CLSID_MsftDiscMaster2), null, 23u, (_GUID*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._GUID_27354130_7f64_5b0f_8f00_5d77afbe261e), (void**)(&ptr)) >= 0;
				if (flag)
				{
					IUnknown* intPtr = ptr;
	...
	public unsafe EBurnState CurrentBurnState
	{
		get
		{
			...
			{
				System.Runtime.CompilerServices.Unsafe.SkipInit(out __MIDL___MIDL_itf_wmpcd_0000_0014_0001 _MIDL___MIDL_itf_wmpcd_0000_0014_);
	...
	public unsafe long SpaceAvailable
	{
		get
		{
			...
			{
				System.Runtime.CompilerServices.Unsafe.SkipInit(out ulong num2);
	...
	public unsafe string TOC
	{
		get
		{
			...
			string result = null;
			if (pDevice != null && IsMediaLoaded)
			{
				IWMPCDDevice* pDevice = pDevice;
				System.Runtime.CompilerServices.Unsafe.SkipInit(out IWMPCDMediaInfo* ptr);
				if (((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, IWMPCDMediaInfo**, int>)(*(ulong*)(*(long*)pDevice + 112)))((nint)pDevice, &ptr) >= 0)
				{
					ushort* ptr2 = null;
					if (((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, ushort**, int>)(*(ulong*)(*(long*)ptr + 32)))((nint)ptr, &ptr2) >= 0)
					{
	...
	public unsafe int GetTrackUrl(uint dwTrackNum, StringBuilder strBuilder)
	{
		...
		if (pDevice != null && IsMediaLoaded)
		{
			...
			{
				ushort* ptr2 = null;
				num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, uint, ushort**, int>)(*(ulong*)(*(long*)ptr + 56)))((nint)ptr, dwTrackNum, &ptr2);
				if (num >= 0)
				{
	...
	public unsafe HRESULT SetBurnPlaylist(int iPlaylistId)
	{
		...
		if (num >= 0)
		{
			num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, uint*, int>)(*(ulong*)(*(long*)ptr2 + 88)))((nint)ptr2, &num2);
			if (num >= 0)
			{
				if (num2 != 0)
				{
					...
					while (num3 < num2)
					{
						...
						try
						{
							...
							try
							{
								num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, uint, uint, tagPROPVARIANT*, int>)(*(ulong*)(*(long*)ptr2 + 48)))((nint)ptr2, num3, 233u, (tagPROPVARIANT*)(&cComPropVariant));
								if (num >= 0)
								{
				...
				if (num >= 0)
				{
					...
					num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, IPlaylist*, int>)(*(ulong*)(*(long*)burnPublisher + 88)))((nint)burnPublisher, ptr);
				}
			}
		}
		if (0L != (nint)ptr)
	...
	public unsafe HRESULT SetVolumeLabelW(string strVolumeLabel)
	{
		...
		fixed (ushort* ptr = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(strVolumeLabel)))
		{
	...
	private unsafe int AdviseForBurnPublisherEvents()
	{
		...
		CBurnPublisherCallback* ptr = (CBurnPublisherCallback*)global::_003CModule_003E.@new(24uL);
		...
		{
			IBurnPublisher* burnPublisher = BurnPublisher;
			System.Runtime.CompilerServices.Unsafe.SkipInit(out uint dwBurnAdviseCookie);
	...
	private unsafe void UnadviseForBurnPublisherEvents()
	{
		...
		{
			IBurnPublisher* burnPublisher = BurnPublisher;
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, uint, int>)(*(ulong*)(*(long*)burnPublisher + 200)))((nint)burnPublisher, m_dwBurnAdviseCookie);
