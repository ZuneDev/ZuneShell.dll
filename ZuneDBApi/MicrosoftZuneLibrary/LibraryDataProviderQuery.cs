...
internal class LibraryDataProviderQuery : DataProviderQuery
{
	...
	private unsafe void BeginExecuteWorker(object state)
	{
		...
		if (property != null)
		{
			...
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, IDList*, int>)(*(ulong*)num2))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)4, queryPropertyBag.PackIDList((IList)property));
		}
		object property2 = GetProperty("GenreIds");
		if (property2 != null)
		{
			long num3 = *(long*)iQueryPropertyBag + 24;
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, IDList*, int>)(*(ulong*)num3))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)12, queryPropertyBag.PackIDList((IList)property2));
		}
		object property3 = GetProperty("AlbumIds");
		if (property3 != null)
		{
			long num4 = *(long*)iQueryPropertyBag + 24;
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, IDList*, int>)(*(ulong*)num4))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)7, queryPropertyBag.PackIDList((IList)property3));
		}
		object property4 = GetProperty("UserCardIds");
		if (property4 != null)
		{
			long num5 = *(long*)iQueryPropertyBag + 24;
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, IDList*, int>)(*(ulong*)num5))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)30, queryPropertyBag.PackIDList((IList)property4));
		}
		object property5 = GetProperty("DeviceId");
		if (property5 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)1, (int)property5);
		}
		else
		{
		...
		if (property6 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)18, (int)property6);
		}
		property6 = GetProperty("UserId");
		if (property6 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)0, (int)property6);
		}
		else
		{
		...
		if (property7 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)26, (int)property7);
		}
		...
		if (property10 != null)
		{
			fixed (ushort* ptr2 = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars((string)property10)))
			{
				try
				{
					long num6 = *(long*)iQueryPropertyBag + 40;
					((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, ushort*, int>)(*(ulong*)num6))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)19, ptr2);
				}
				catch
				{
					//try-fault
		...
		if (property11 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)5, (int)property11);
		}
		property11 = GetProperty("ArtistId");
		if (property11 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)3, (int)property11);
		}
		property11 = GetProperty("GenreId");
		if (property11 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)11, (int)property11);
		}
		property11 = GetProperty("AlbumId");
		if (property11 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)6, (int)property11);
		}
		property11 = GetProperty("FolderId");
		if (property11 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)9, (int)property11);
		}
		...
		if (property13 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)13, (int)property13);
		}
		object property14 = GetProperty("TOC");
		if (property14 != null)
		{
			fixed (ushort* ptr3 = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars((string)property14)))
			{
				try
				{
					long num7 = *(long*)iQueryPropertyBag + 40;
					((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, ushort*, int>)(*(ulong*)num7))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)20, ptr3);
				}
				catch
				{
					//try-fault
		...
		if (property15 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)8, (int)property15);
		}
		property15 = GetProperty("WatchType");
		if (property15 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)32, (int)property15);
		}
		...
		if (property16 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)16, (int)property16);
		}
		property16 = GetProperty("InitTime");
		if (property16 != null)
		{
			fixed (ushort* ptr4 = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars((string)property16)))
			{
				try
				{
					long num8 = *(long*)iQueryPropertyBag + 40;
					((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, ushort*, int>)(*(ulong*)num8))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)17, ptr4);
				}
				catch
				{
					//try-fault
		...
		if (property17 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)10, (int)property17);
		}
		property17 = GetProperty("CategoryId");
		if (property17 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)27, (int)property17);
		}
		...
		if (property18 != null)
		{
			...
			if (num9 != 0)
			{
				((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)25, num9);
			}
		}
		object property19 = GetProperty("MaxResultCount");
		if (property19 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)31, (int)property19);
		}
		...
		if (property19 != null)
		{
			...
			if (num10 != 0L)
			{
				((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, ulong, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 48)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)34, num10);
			}
		}
		...
		else
		{
			...
			case "Genres":
			{
				...
				int num12 = ((property21 == null) ? 3 : ((int)property21));
				((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EQueryPropertyBagProp, int, int>)(*(ulong*)(*(long*)iQueryPropertyBag + 56)))((nint)iQueryPropertyBag, (EQueryPropertyBagProp)13, num12);
		...
		if ((byte)((num != m_requestGeneration) ? 1 : 0) == 0 && num13 >= 0)
		{
		...
		if (num13 < 0)
		{
			throw new COMException("Could not perform query " + text, num13);
		}
	}
	...
	private unsafe void DeferredSetResult(object state)
	{
		...
		if (!m_disposed && deferredSetResultArgs.RequestGeneration == m_requestGeneration)
		{
			...
			if (deferredSetResultArgs.QueryList != null)
			{
				...
				ReleaseBehavior visualReleaseBehavior = ((!deferredSetResultArgs.RetainedList) ? ReleaseBehavior.ReleaseReference : ReleaseBehavior.KeepReference);
