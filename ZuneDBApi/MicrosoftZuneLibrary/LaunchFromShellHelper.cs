...
public class LaunchFromShellHelper
{
	...
	private unsafe void ThreadProc()
	{
		...
		fixed (ushort* ptr2 = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(_startParam)))
		{
			...
			try
			{
				...
				{
					long num2 = *(long*)ptr;
					num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, ushort*, int, delegate* unmanaged[Cdecl, Cdecl]<ushort*, EMediaTypes, void>, int>)(*(ulong*)num2))((nint)ptr, ptr2, _startParamIsDataObject ? 1 : 0, delegate_002A);
				}
				if (_eventName != null)
				{
					try
				...
				if (num >= 0)
				{
					...
					{
						num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, bool*, int>)(*(ulong*)(*(long*)ptr + 8)))((nint)ptr, &flag);
					}
				}
			}
			finally
