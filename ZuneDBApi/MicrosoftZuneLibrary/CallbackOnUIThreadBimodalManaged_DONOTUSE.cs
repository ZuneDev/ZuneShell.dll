...
public class CallbackOnUIThreadBimodalManaged_DONOTUSE : IDisposable
{
	...
	public unsafe CallbackOnUIThreadBimodalManaged_DONOTUSE(IRequestCallbackOnUIThread pUI)
	{
		...
		_pUI = pUI;
		CallbackOnUIThreadBimodalUnmanaged_DONOTUSE* ptr = (CallbackOnUIThreadBimodalUnmanaged_DONOTUSE*)global::_003CModule_003E.@new(16uL);
	...
	private unsafe void _0021CallbackOnUIThreadBimodalManaged_DONOTUSE()
	{
		...
		if (pUnmanaged != null)
		{
			global::_003CModule_003E.MicrosoftZuneLibrary_002ECallbackOnUIThreadBimodalUnmanaged_DONOTUSE_002E__delDtor(pUnmanaged, 1u);
		}
	}
