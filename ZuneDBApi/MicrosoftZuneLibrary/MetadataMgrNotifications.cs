...
public class MetadataMgrNotifications : IDisposable
{
	...
	public unsafe MetadataMgrNotifications()
	{
		...
		NativeMetadataNotifications* ptr = (NativeMetadataNotifications*)global::_003CModule_003E.@new(24uL);
		...
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IMetadataChangeNotify* ptr3);
		if (ptr2 == null || ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, _GUID*, void**, int>)(*(ulong*)(*(ulong*)ptr2)))((nint)ptr2, (_GUID*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._GUID_d67cdf64_5ea9_44ea_bf5c_29a422f4c23f), (void**)(&ptr3)) < 0)
		{
			return;
		}
