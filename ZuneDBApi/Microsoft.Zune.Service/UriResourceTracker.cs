...
public class UriResourceTracker : IDisposable
{
	...
	public unsafe bool SetResourceModified(string strUrlResource, [MarshalAs(UnmanagedType.U1)] bool fModified)
	{
		...
		{
			fixed (ushort* ptr = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(strUrlResource)))
			{
				try
				{
					long num = *(long*)m_pUriResourceTracker + 24;
					result = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, ushort*, byte, int>)(*(ulong*)num))((nint)m_pUriResourceTracker, ptr, fModified ? ((byte)1) : ((byte)0)) >= 0;
				}
				catch
				{
					//try-fault
		...
		if (m_pUriResourceTracker != null)
		{
			fixed (ushort* ptr = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(strUrlResource)))
			{
				try
				{
					...
					result = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, ushort*, byte>)(*(ulong*)num))((nint)m_pUriResourceTracker, ptr) != 0;
				}
				catch
				{
					//try-fault
