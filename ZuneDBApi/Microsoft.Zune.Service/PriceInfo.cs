...
public class PriceInfo
{
	...
	internal unsafe void Init(IPriceInfo* pPriceInfo)
	{
		...
		bool hasPoints = ((((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int>)(*(ulong*)(*(long*)pPriceInfo + 40)))((nint)pPriceInfo) != 0) ? true : false);
		m_hasPoints = hasPoints;
		bool hasCurrency = ((((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int>)(*(ulong*)(*(long*)pPriceInfo + 48)))((nint)pPriceInfo) != 0) ? true : false);
