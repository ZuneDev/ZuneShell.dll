...
public class AccountSettings
{
	...
	internal unsafe AccountSettings(INewsletterSettings* pNewsletterSettings, IPrivacySettings* pPrivacySettings)
	{
		...
		m_allowZuneEmails = ((System.Runtime.CompilerServices.Unsafe.As<NewsletterOptions, int>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref newsletterOptions, 4)) != 0) ? true : false);
		m_allowPartnerEmails = ((System.Runtime.CompilerServices.Unsafe.As<NewsletterOptions, int>(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref newsletterOptions, 8)) != 0) ? true : false);
		...
		System.Runtime.CompilerServices.Unsafe.SkipInit(out EPrivacySettingId key);
		System.Runtime.CompilerServices.Unsafe.SkipInit(out EPrivacySettingValue value);
