...
internal class FileAssociationHandlerWrapper : IFileAssociationHandler, IDisposable
{
	...
	public unsafe virtual int GetFileAssociationInfoList(out IList<FileAssociationInfo> fileAssociationInfoList)
	{
		...
		if (num2 >= 0)
		{
			ptr = (global::FileAssociationInfo*)global::_003CModule_003E.new_005B_005D((ulong)num * 32uL);
			if (ptr == null)
			{
				num2 = -2147024882;
			}
	...
	public unsafe virtual int SetFileAssociationInfo(IList<FileAssociationInfo> fileAssociationInfoList)
	{
		...
		global::FileAssociationInfo* ptr = (global::FileAssociationInfo*)global::_003CModule_003E.new_005B_005D((ulong)count * 32uL);
		int num;
		if (ptr == null)
		{
			num = -2147024882;
	...
	internal unsafe int FileInfoToStruct(FileAssociationInfo fileAssocInfo, global::FileAssociationInfo* pFileAssocInfo)
	{
		...
		fixed (ushort* ptr = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(fileAssocInfo.Extension)))
		{
			fixed (ushort* ptr2 = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(fileAssocInfo.ProgId)))
			{
				fixed (ushort* ptr3 = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(fileAssocInfo.Description)))
				{
					*(long*)pFileAssocInfo = (nint)global::_003CModule_003E.SysAllocString(ptr);
					*(long*)((ulong)(nint)pFileAssocInfo + 8uL) = (nint)global::_003CModule_003E.SysAllocString(ptr2);
	...
	internal unsafe void CleanupFileInfoArray(global::FileAssociationInfo* rgFileInfo, uint cFileInfo)
	{
		...
		if (0 < cFileInfo)
		{
			...
			do
			{
				...
				if (num4 != 0L)
				{
					global::_003CModule_003E.SysFreeString((ushort*)num4);
				}
