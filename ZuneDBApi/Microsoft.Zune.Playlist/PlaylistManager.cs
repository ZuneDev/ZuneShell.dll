...
public class PlaylistManager : IDisposable
{
	...
	public unsafe HRESULT CreatePlaylist(string title, string author, [In] ValueType serviceMediaId, CreatePlaylistOption options, out int playlistId)
	{
		...
		//IL_0115: Expected I, but got I8
		//IL_00e8->IL00ea: Incompatible stack types: I8 vs Ref
		...
		else
		{
			fixed (ushort* ptr = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(title)))
			{
				try
				{
					fixed (ushort* ptr2 = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(author)))
					{
						try
						{
							...
							*(int*)(&gUID) = 0;
							...
							_GUID* ptr3 = (_GUID*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref serviceMediaId != null ? ref *(_003F*)(&gUID) : ref *(_003F*)null);
							long num = *(long*)m_pPlaylistManager + 24;
							System.Runtime.CompilerServices.Unsafe.SkipInit(out int num2);
							hr = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, ushort*, ushort*, _GUID*, int*, EPlaylistType, EPlaylistCreateConflictAction, int, tagVARIANT*, int>)(*(ulong*)num))((nint)m_pPlaylistManager, ptr, ptr2, ptr3, &num2, ePlaylistType, ePlaylistCreateConflictAction, flag6 ? 1 : 0, null);
							playlistId = num2;
						}
						catch
						{
	...
	public unsafe HRESULT AddMediaToPlaylist(int playlistId, int cMediaCount, int[] mediaIds, int[] mediaTypeIds, int insertPos, [Out] int[] playlistContentIds)
	{
		...
		//IL_0017->IL001e: Incompatible stack types: I8 vs Ref
		//IL_0027->IL002f: Incompatible stack types: I8 vs Ref
		//IL_0038->IL0040: Incompatible stack types: I8 vs Ref
		int hr;
						...
						try
						{
							fixed (int* ptr3 = &(playlistContentIds != null ? ref playlistContentIds[0] : ref *(int*)null))
							{
								try
								{
									...
									hr = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int, int, int*, int*, int, int*, int>)(*(ulong*)num))((nint)m_pPlaylistManager, playlistId, cMediaCount, ptr, ptr2, insertPos, ptr3);
								}
								catch
								{
									//try-fault
	...
	public unsafe void RemoveMediaFromPlaylist(int playlistId, int cIdCount, int[] playlistContentIds)
	{
		...
		//IL_000f->IL0016: Incompatible stack types: I8 vs Ref
		if (m_pPlaylistManager == null)
		{
			return;
		}
		fixed (int* ptr = &(playlistContentIds != null ? ref playlistContentIds[0] : ref *(int*)null))
		{
			try
			{
				...
				((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int, int, int*, int>)(*(ulong*)num))((nint)m_pPlaylistManager, playlistId, cIdCount, ptr);
			}
			catch
			{
				//try-fault
		...
		else
		{
			fixed (int* ptr = &(playlistContentIds != null ? ref playlistContentIds[0] : ref *(int*)null))
			{
				try
				{
					...
					hr = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int, int, int*, int, int>)(*(ulong*)num))((nint)m_pPlaylistManager, playlistId, cPlaylistContentCount, ptr, newPosition);
				}
				catch
				{
					//try-fault
	...
	public unsafe HRESULT RenamePlaylist(int playlistId, string newTitle)
	{
		...
		{
			fixed (ushort* ptr = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(newTitle)))
			{
				try
				{
					long num = *(long*)m_pPlaylistManager + 72;
					hr = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int, ushort*, int>)(*(ulong*)num))((nint)m_pPlaylistManager, playlistId, ptr);
				}
				catch
				{
					//try-fault
	...
	public unsafe HRESULT SavePlaylistAsStatic(int playlistId, PlaylistAsyncOperationCompleted playlistAsyncOperationCompleted)
	{
		...
		PlaylistAsyncOperation* ptr = (PlaylistAsyncOperation*)global::_003CModule_003E.@new(24uL);
		...
		if (ptr2 != null)
		{
			global::_003CModule_003E.Microsoft_002EZune_002EPlaylist_002EPlaylistAsyncOperation_002E__delDtor(ptr2, 1u);
		}
		goto IL_0066;
		IL_0066:
	...
	public unsafe string GetUniquePlaylistTitle(string candidateTitle)
	{
		...
		if (m_pPlaylistManager != null)
		{
			fixed (ushort* ptr = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(candidateTitle)))
			{
				try
				{
					...
					try
					{
						...
						System.Runtime.CompilerServices.Unsafe.SkipInit(out int num2);
						((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, ushort*, int*, tagPROPVARIANT*, int>)(*(ulong*)num))((nint)m_pPlaylistManager, ptr, &num2, (tagPROPVARIANT*)(&cComPropVariant));
