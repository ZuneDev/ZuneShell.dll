...
public class PlayerInterop : IDisposable
{
	...
	public unsafe TimeSpan PositionEventInterval
	{
		...
		set
		{
			...
			if (_uTransport != null)
			{
				...
				((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, uint, int>)(*(ulong*)num))((nint)_uTransport, (uint)value.TotalMilliseconds);
			}
		}
	}
	...
	public unsafe VideoWindow VideoPosition
	{
		set
		{
			...
			*(int*)(&tagRECT) = value.Left;
			...
			if (uDynamicImage != null)
			{
				((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, tagRECT, int>)(*(ulong*)(*(long*)uDynamicImage + 32)))((nint)uDynamicImage, tagRECT);
			}
		}
	}
	...
	{
		//The blocks IL_0069, IL_006e, IL_0071, IL_0095, IL_009f, IL_00b1, IL_00b5, IL_00b8, IL_00c2, IL_00c9, IL_00d7, IL_00dc, IL_00df are reachable both inside and outside the pinned region starting at IL_004f. ILSpy has duplicated these blocks in order to place them both within and outside the `fixed` statement.
		...
		{
			bool result;
			fixed (ushort* ptr = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(b.Id)))
			{
				try
				{
					fixed (ushort* ptr2 = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(b.SourceFile)))
					{
						try
						{
							long num;
							...
							{
								fixed (ushort* ptr3 = &System.Runtime.CompilerServices.Unsafe.AsRef<ushort>(ptr))
								{
									num = *(long*)a;
									short num2 = System.Runtime.CompilerServices.Unsafe.ReadUnaligned<short>((void*)num);
									short num3 = System.Runtime.CompilerServices.Unsafe.ReadUnaligned<short>(ptr3);
									if (num2 >= num3 && num2 <= num3)
									{
										...
										long num4;
										fixed (ushort* ptr4 = &System.Runtime.CompilerServices.Unsafe.AsRef<ushort>(ptr2))
										{
											num4 = *(long*)((ulong)(nint)a + 24uL);
											short num5 = System.Runtime.CompilerServices.Unsafe.ReadUnaligned<short>((void*)num4);
											short num6 = System.Runtime.CompilerServices.Unsafe.ReadUnaligned<short>(ptr4);
											int num7;
										...
										while (true)
										{
											fixed (ushort* ptr4 = &System.Runtime.CompilerServices.Unsafe.Add(ref reference2, 1))
											{
												short num5 = System.Runtime.CompilerServices.Unsafe.ReadUnaligned<short>((void*)num4);
												short num6 = System.Runtime.CompilerServices.Unsafe.ReadUnaligned<short>(ptr4);
												int num7;
							...
							while (true)
							{
								fixed (ushort* ptr3 = &System.Runtime.CompilerServices.Unsafe.Add(ref reference, 1))
								{
									short num2 = System.Runtime.CompilerServices.Unsafe.ReadUnaligned<short>((void*)num);
									short num3 = System.Runtime.CompilerServices.Unsafe.ReadUnaligned<short>(ptr3);
									if (num2 >= num3 && num2 <= num3)
	...
	internal unsafe void OnStatusChanged(MCPlayerStatus* pStatus)
	{
		...
		ulong num4 = *(ulong*)((ulong)(nint)pStatus + 24uL);
		if (num4 == 0L)
		{
		...
		else if (!HResultDenialsEqual((MCHResultAnnouncement*)num4, _firstDenial))
		{
	...
	internal unsafe void OnPropertyChanged(ushort* wzKey, byte* pData, uint dataLength)
	{
		...
		if (pData != null)
		{
			...
			{
				_volume = *(int*)pData;
				int mute = ((*(int*)((ulong)(nint)pData + 4uL) != 0) ? 1 : 0);
				_mute = (byte)mute != 0;
			}
			...
			{
				System.Runtime.CompilerServices.Unsafe.SkipInit(out _MBRHEURISTICDATA mBRHEURISTICDATA);
	...
	internal unsafe void OnTransportStatusChanged(MCTransportStatus* pTransportStatus)
	{
		...
		int endOfMedia = ((*(bool*)((ulong)(nint)pTransportStatus + 8uL)) ? 1 : 0);
		_endOfMedia = (byte)endOfMedia != 0;
		int canSeek = ((*(bool*)((ulong)(nint)pTransportStatus + 9uL)) ? 1 : 0);
	...
	public unsafe void Initialize()
	{
		...
		{
			_uPlayer = ptr;
			num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, _GUID*, void**, int>)(*(ulong*)(*(ulong*)ptr)))((nint)ptr, (_GUID*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._GUID_2f33a725_95cb_4080_adef_93a067a707ba), (void**)(&ptr2));
			if (num >= 0 && ptr2 != null)
			{
				_uTransport = ptr2;
				IMCPlayer* uPlayer = _uPlayer;
				num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, _GUID*, void**, int>)(*(ulong*)(*(ulong*)uPlayer)))((nint)uPlayer, (_GUID*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._GUID_58864c93_45f9_4c6d_aa3f_80f6caa08281), (void**)(&ptr3));
				if (num >= 0 && ptr3 != null)
				{
					_uSetUri = ptr3;
					IMCPlayer* uPlayer2 = _uPlayer;
					num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, _GUID*, void**, int>)(*(ulong*)(*(ulong*)uPlayer2)))((nint)uPlayer2, (_GUID*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._GUID_102e281e_28ad_4688_aaff_f560f8053d90), (void**)(&ptr4));
					if (num >= 0 && ptr4 != null)
					{
						_uDynamicImage = ptr4;
						num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int, int>)(*(ulong*)(*(long*)ptr4 + 24)))((nint)ptr4, _nDynamicImage);
						if (num < 0)
						{
							throw new COMException("PlayerInterop failed to initialize IMCDynamicImage", num);
						}
						IMCPlayer* uPlayer3 = _uPlayer;
						num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, _GUID*, void**, int>)(*(ulong*)(*(ulong*)uPlayer3)))((nint)uPlayer3, (_GUID*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._GUID_f6ba930c_78c3_488c_924d_2d3fc1e8fb70), (void**)(&ptr5));
						if (num >= 0 && ptr5 != null)
						{
							_uVolumeControl = ptr5;
							IMCPlayer* uPlayer4 = _uPlayer;
							num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, _GUID*, void**, int>)(*(ulong*)(*(ulong*)uPlayer4)))((nint)uPlayer4, (_GUID*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._GUID_aff1732d_13f3_45e5_a52f_a854729e8730), (void**)(&ptr6));
							if (num >= 0 && ptr6 != null)
							{
								_uZuneSpectrumMgr = ptr6;
								CPlayerInteropEventSink* ptr7 = (CPlayerInteropEventSink*)global::_003CModule_003E.@new(48uL);
								...
								num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, HWND__*, uint, IMCPlayerEvents*, int>)(*(ulong*)num2))((nint)_uPlayer, (HWND__*)_windowHandle.ToPointer(), 0u, (IMCPlayerEvents*)ptr8);
								if (num < 0)
								{
								...
								num = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, uint, int>)(*(ulong*)num3))((nint)_uTransport, (uint)_positionEventInterval.TotalMilliseconds);
	...
	public unsafe void Uninitialize()
	{
		...
		if (_uPlayer != null)
		{
			...
			byte condition = (byte)((global::_003CModule_003E.WaitForSingleObject(_gotStateUninitializeEvent, 5000u) == 0 && _state == MCPlayerState.Uninitialized) ? 1 : 0);
	...
	public unsafe void Play()
	{
		...
		if (uVolumeControl != null && _uTransport != null)
		{
			...
			{
				((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, int, int>)(*(ulong*)(*(long*)uVolumeControl + 24)))((nint)uVolumeControl, _volume);
			}
			IMCTransport* uTransport = _uTransport;
	...
	public unsafe void SetUri(string uri, long startPositionIn100nsUnits, int UriID)
	{
		...
		fixed (ushort* ptr = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(uri)))
		{
			try
			{
				IMCPlayerSetUri* uSetUri = _uSetUri;
				if (uSetUri != null)
				{
					...
					((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, ushort*, long, uint, int>)(*(ulong*)num))((nint)_uSetUri, ptr, startPositionIn100nsUnits, (uint)UriID);
				}
			}
			catch
			{
	...
	public unsafe void ProgressivePlaybackReleaseFile()
	{
		...
		{
			*(long*)((ulong)(nint)_uEventSink + 40uL) = (nint)global::_003CModule_003E.CreateEventW(null, 0, 0, null);
			...
			byte condition = ((global::_003CModule_003E.WaitForSingleObject((void*)(*(ulong*)((ulong)(nint)_uEventSink + 40uL)), 30000u) == 0) ? ((byte)1) : ((byte)0));
	...
	public unsafe void ProgressivePlaybackReopenFile()
	{
		...
		if (uTransport != null)
		{
			...
			if (uEventSink != null && *(long*)((ulong)(nint)uEventSink + 40uL) != 0L)
			{
				...
				global::_003CModule_003E.CloseHandle((void*)(*(ulong*)((ulong)(nint)_uEventSink + 40uL)));
