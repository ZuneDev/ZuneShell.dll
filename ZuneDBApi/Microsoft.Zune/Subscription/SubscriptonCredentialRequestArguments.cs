...
public class SubscriptonCredentialRequestArguments
{
    ...
    internal SubscriptonCredentialRequestArguments(int subscriptionMediaId, string targetUrl, AuthenticationSchemes authScheme, bool isAuthSchemeSafe, string realm, string lastUserName, int lastError)
    {
