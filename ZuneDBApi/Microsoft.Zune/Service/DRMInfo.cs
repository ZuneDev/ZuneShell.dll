...
public class DRMInfo
{
    ...
    {
        [return: MarshalAs(UnmanagedType.U1)]
        get { return m_expiryDate != DateTime.MaxValue; }
    }

    public bool LicenseExpired
    {
        [return: MarshalAs(UnmanagedType.U1)]
        get { return m_canPlay == DRMQueryState.LicenseExpired; }
    }

    public bool NoLicense
    {
        [return: MarshalAs(UnmanagedType.U1)]
        get { return m_canPlay == DRMQueryState.NoLicense; }
    }

    public bool ValidLicense
    {
        [return: MarshalAs(UnmanagedType.U1)]
        get { return m_canPlay == DRMQueryState.ValidLicense; }
    }

    public bool NotProtected
    {
        [return: MarshalAs(UnmanagedType.U1)]
        get { return m_canPlay == DRMQueryState.NotProtected; }
    }
