...
public class VideoOffer : Offer
{
    ...
    public bool IsSeasonPurchase
    {
        ...
        get { return m_isSeasonPurchase; }
    }

    public bool IsMusicVideo
    {
        [return: MarshalAs(UnmanagedType.U1)]
        get { return m_isMusicVideo; }
    }

    public bool IsStream
    {
        [return: MarshalAs(UnmanagedType.U1)]
        get { return m_isStream; }
    }

    public bool IsRental
    {
        [return: MarshalAs(UnmanagedType.U1)]
        get { return m_isRental; }
    }
        ...
        : base(id, title, artist, priceInfo, isMP3: false, previouslyPurchased, inCollection, null)
    {
        ...
        if (!string.IsNullOrEmpty(expirationDate))
        {
            try
            {
                m_expirationDate = XmlConvert.ToDateTime(expirationDate, XmlDateTimeSerializationMode.Utc);
            }
