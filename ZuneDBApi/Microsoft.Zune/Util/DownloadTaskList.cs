...
public class DownloadTaskList : AggregateList
{
    ...
    public static DownloadTaskList Instance => m_instance ??= new DownloadTaskList();
    ...
    {
        return m_completedDownloadTasks.Count + m_cancelledDownloadTasks.Count + m_failedDownloadTasks.Count;
    }
