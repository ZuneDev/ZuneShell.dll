...
namespace Microsoft.Zune.Configuration
{
    public class TunerInfo
    {
        ...
        {
            get { return m_name != null && m_name.Length != 0 ? m_name : m_tunerId; }
        }
        ...
        internal TunerInfo(string name, string tunerId, string tunerVersion, TunerType tunerType, TunerRegisterType tunerRegisterType, string dateCreated, string dateLastUsed)
        {
            ...
            m_dtCreated = (dateCreated == null || !DateTime.TryParse(dateCreated, out DateTime dt)) ? DateTime.MinValue : dt;
            m_dtLastUsed = (dateLastUsed == null || !DateTime.TryParse(dateLastUsed, out DateTime dt2)) ? DateTime.MinValue : dt2;
        }
    }
}