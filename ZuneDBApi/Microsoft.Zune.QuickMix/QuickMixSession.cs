...
public class QuickMixSession : IDisposable
{
	...
	public unsafe HRESULT GetSimilarMedia(uint maxBatchTracks, TimeSpan maxBatchTimeout, SimilarMediaBatchHandler similarBatchHandler, BatchEndHandler batchEndHandler)
	{
		...
		if (num >= 0)
		{
			IQuickMixSession* p = m_spSession.p;
			long num3 = *(long*)p + 48;
			num2 = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EPlaylistLimitType, uint, uint, IQuickMixSessionCallback*, int>)(*(ulong*)num3))((nint)p, (EPlaylistLimitType)2, maxBatchTracks, (uint)maxBatchTimeout.TotalMilliseconds, (IQuickMixSessionCallback*)ptr2);
		}
		if (ptr2 != null)
		{
	...
	public unsafe HRESULT GetSimilarMedia(TimeSpan maxBatchDuration, TimeSpan maxBatchTimeout, SimilarMediaBatchHandler similarBatchHandler, BatchEndHandler batchEndHandler)
	{
		...
		if (num >= 0)
		{
			IQuickMixSession* p = m_spSession.p;
			long num3 = *(long*)p + 48;
			num2 = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, EPlaylistLimitType, uint, uint, IQuickMixSessionCallback*, int>)(*(ulong*)num3))((nint)p, (EPlaylistLimitType)1, (uint)maxBatchDuration.TotalSeconds, (uint)maxBatchTimeout.TotalMilliseconds, (IQuickMixSessionCallback*)ptr2);
		}
		if (ptr2 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, uint>)(*(ulong*)(*(long*)ptr2 + 16)))((nint)ptr2);
	...
	public unsafe HRESULT Refresh(TimeSpan maxBatchTimeout, [MarshalAs(UnmanagedType.U1)] bool reloadSettings, SimilarMediaBatchHandler similarBatchHandler, BatchEndHandler batchEndHandler)
	{
		...
		if (num >= 0)
		{
			IQuickMixSession* p = m_spSession.p;
			long num3 = *(long*)p + 56;
			num2 = ((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, uint, byte, IQuickMixSessionCallback*, int>)(*(ulong*)num3))((nint)p, (uint)maxBatchTimeout.TotalMilliseconds, reloadSettings ? ((byte)1) : ((byte)0), (IQuickMixSessionCallback*)ptr2);
		}
		if (ptr2 != null)
		{
			((delegate* unmanaged[Cdecl, Cdecl]<IntPtr, uint>)(*(ulong*)(*(long*)ptr2 + 16)))((nint)ptr2);
	...
	public unsafe HRESULT SaveAsPlaylist(string playlistTitle, CreatePlaylistOption createOption, out int playlistId)
	{
		...
		int num = -1;
		fixed (ushort* ptr = &System.Runtime.CompilerServices.Unsafe.As<char, ushort>(ref global::_003CModule_003E.PtrToStringChars(playlistTitle)))
		{
			int num2;
