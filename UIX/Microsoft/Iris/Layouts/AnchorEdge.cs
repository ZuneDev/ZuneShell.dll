...
namespace Microsoft.Iris.Layouts
{
    internal class AnchorEdge
    {
        ...
        public override string ToString()
        {
            ...
            if ((double)this._maximumPercentValue > 0.0)
            {
            ...
            if ((double)this._minimumPercentValue > 0.0)
            {
        ...
        public static bool operator ==(AnchorEdge lhs, AnchorEdge rhs)
        {
            if ((object)lhs == null && (object)rhs == null)
                return true;
            return (object)lhs != null && lhs.Equals((object)rhs);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return (object)anchorEdge != null && this.Id == anchorEdge.Id && ((double)this.Percent == (double)anchorEdge.Percent && this.Offset == anchorEdge.Offset) && (this.MaximumSet == anchorEdge.MaximumSet && (double)this.MaximumPercent == (double)anchorEdge.MaximumPercent && (this.MaximumOffset == anchorEdge.MaximumOffset && this.MinimumSet == anchorEdge.MinimumSet)) && (double)this.MinimumPercent == (double)anchorEdge.MinimumPercent && this.MinimumOffset == anchorEdge.MinimumOffset;
        }
